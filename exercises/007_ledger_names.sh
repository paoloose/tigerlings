...
tb "create_transfers id=70000 debit_account_id=702 credit_account_id=703 amount=100 ledger=${EUR_LEDGER} code=10;"

tb "create_transfers id=70001 debit_account_id=704 credit_account_id=705 amount=100 ledger=${YEN_LEDGER} code=10;"

tb "create_transfers id=70002 debit_account_id=700 credit_account_id=701 amount=100 ledger=${USD_LEDGER} code=10;"
