...
# Because no transfer can be made from different ledgers, for currency exchange you'll need to
# create a third account across the two ledgers, and use it as a temporary account to link the two transfers.
# Wouldn't it have been better to call this account "currency clearing" instead of "liquidity"?
