...
SOURCE_ACCOUNT=2810 # credit account
DESTINATION_ACCOUNT=2811 # debit account
...
TRANSFER_AMOUNT=50
tb "create_transfers id=28005 debit_account_id=$SOURCE_ACCOUNT credit_account_id=$CONTROL_ACCOUNT amount=$THRESHOLD_AMOUNT ledger=280 code=10 flags=linked,
                     id=28006 debit_account_id=$CONTROL_ACCOUNT credit_account_id=$SOURCE_ACCOUNT amount=$THRESHOLD_AMOUNT ledger=280 code=10 flags=linked,
                     id=28007 debit_account_id=$SOURCE_ACCOUNT credit_account_id=$DESTINATION_ACCOUNT amount=$TRANSFER_AMOUNT ledger=280 code=10;"
